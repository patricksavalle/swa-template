...
- What research methods were used (web search, academic sources, industry
  reports, etc.)
...
**Implications:** [1-2 paragraphs on what this finding means for the user's
...
[Follow same detailed structure as Finding 1] [Minimum 300 words per finding]
...
**Pattern 1: [Name]** [Explain the pattern in detail, cite which findings
support it]
...
**Insight 1: [Name]** [What you discovered by connecting information across
sources] [Why this matters even though no single source said it explicitly]
...
**For [User Context]:** [Specific implications for the user's
situation/decision]
...
[1] Author Name or Organization (2025). "Full Title of Article or Paper".
Publication Name or Website. https://full-url.com (Retrieved: 2025-11-04)

[2] Second Author (2024). "Second Article Title". Journal Name, Volume(Issue),
pages. https://doi-or-url.com (Retrieved: 2025-11-04)
...
**Research Mode:** [Quick/Standard/Deep/UltraDeep] **Total Sources:** [Number]
**Word Count:** [Approximate count] **Research Duration:** [Time taken]
**Generated:** [Date and time] **Validation Status:** [Passed with X warnings /
