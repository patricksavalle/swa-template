...
description: >-
    ...
    complexity justified?", "is this defensive check necessary?", "does this
    code solve a real problem in our stack?", or is otherwise weighing scope
    or necessity against engineering cost — including feature triage, backlog
    grooming, tech-debt reviews, PR scope pushback, dead-code audits,
    retrospective module reviews, and detection of impossible-state guards,
    redundant validation layers, cargo-culted patterns, phantom requirements,
