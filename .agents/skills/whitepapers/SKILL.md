...
name: whitepapers
description:
    Use when producing research-heavy whitepapers or technical guides that
    require structured argumentation and data.
---
...
1. **Audience & Compliance** – confirm regulatory constraints, required
   disclaimers, reading level.
2. **Outline** – Executive summary, background, methodology, findings,
   recommendations, CTA.
3. **Research Layer** – cite third-party analysts, customer benchmarks,
   proprietary data.
4. **Design Considerations** – include charts, call-out boxes, and glossary;
